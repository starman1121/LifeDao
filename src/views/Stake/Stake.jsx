...
function Stake() {
  ...
  const ohmBalance = useSelector(state => {
    return state.account.balances && state.account.balances.PAL;
  });
  ...
  const wsohmBalance = useSelector(state => {
    return state.account.balances && state.account.balances.wsPAL;
  });
  const stakeAllowance = useSelector(state => {
    return state.account.staking && state.account.staking.PALStake;
  });
  console.log("debug->stakeAllowance", stakeAllowance);
  const unstakeAllowance = useSelector(state => {
    return state.account.staking && state.account.staking.PALUnstake;
  });
  ...
  console.log('debug->APY',stakingAPY);
                              ...
                              <Typography variant="body1" className="stake-note" color="textSecondary">
                                {view === 0 ? (
                                  <>
                                    ...
                                    <br />
                                    Please approve Paladins DAO to use your <b>PAL</b> for staking.
                                  </>
                                ) : (
                                  <>
                                    First time unstaking <b>sPAL</b>?
                                    <br />
                                    Please approve Paladins DAO to use your <b>sPAL</b> for unstaking.
                                  </>
                                )}
                              </Typography>
                            </Box>
