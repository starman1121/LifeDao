...
import { abi as PALBusdContract } from "src/abi/bonds/PALBusdContract.json";
...
export const busd = new StableBond({
  ...
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0x61cE0e958Cd1340e8966540c463a482654F9b375",
...
export const pal_busd = new LPBond({
  ...
  bondContractABI: PALBusdContract,
  reserveContract: ReserveMtnBusdContract,
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0x5eF41b7116E89B66Fb55C256E2187C1593f6379F",
      reserveAddress: "0x536872155d9A8fE1d7Acc5D4bb9ECc93225BA7F8",
    },
    [NetworkID.Testnet]: {
  ...
  lpUrl:
    "https://pancakeswap.finance/add/0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56/0x1f4BCefFfA2703F824E73E6F214C537cffB19390",
});
...
export const allBonds = [busd, pal_busd];//mtn_wbnb, cake
