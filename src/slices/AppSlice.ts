...
export const loadAppDetails = createAsyncThunk(
  ...
  async ({ networkID, provider }: IBaseAsyncThunk, { dispatch }) => {
    ...
    const sHecMainContract = new ethers.Contract(addresses[networkID].SPAL_ADDRESS as string, sOHMv2, provider);
    const hecContract = new ethers.Contract(addresses[networkID].PAL_ADDRESS as string, ierc20Abi, provider);
    ...
    console.log("debug->circ", circ, sHecMainContract);
    ...
    console.log('debug->currentIndex', circ,stakingReward);
