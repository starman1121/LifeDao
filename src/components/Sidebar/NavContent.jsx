...
import { ReactComponent as ConversionIcon } from "../../assets/icons/conversion.svg";
            ...
            <div className="dapp-nav" id="navbarNav">
              <Link
                ...
                isActive={(match, location) => {
                  return checkPage(match, location, "conversion");
                }}
                className={`button-dapp-menu ${isActive ? "active" : ""}`}
              >
                <Typography variant="h6">
                  <SvgIcon color="primary" component={ConversionIcon} />
                  Conversion
                </Typography>
              </Link>
