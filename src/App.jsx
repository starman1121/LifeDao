...
import { Stake, ChooseBond, Bond, TreasuryDashboard, PoolTogether, Calculator ,Convert} from "./views";
...
function App() {
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSafetyCheck()) {
      dispatch(info("Safety Check: Always verify you're on Paladins.finance!"));
    }
  }, []);
